# @f1stnpm2/excepturi-non-doloremque
...
[![CI](https://github.com/f1stnpm2/excepturi-non-doloremque/actions/workflows/npm-publish.yml/badge.svg)](https://github.com/f1stnpm2/excepturi-non-doloremque/actions)
[![NPM ver](https://img.shields.io/npm/v/@f1stnpm2/excepturi-non-doloremque?color=33cd56&logo=npm)](https://www.npmjs.com/package/@f1stnpm2/excepturi-non-doloremque)
[![install size](https://packagephobia.com/badge?p=@f1stnpm2/excepturi-non-doloremque)](https://packagephobia.com/result?p=@f1stnpm2/excepturi-non-doloremque)
[![deps](https://img.shields.io/librariesio/release/npm/@f1stnpm2/excepturi-non-doloremque)](https://libraries.io/npm/@f1stnpm2/excepturi-non-doloremque)
![LoC](https://tokei.rs/b1/github/gnabgib/@f1stnpm2/excepturi-non-doloremque-ts)
![](coverage.svg)

<!-- 
Too new (npms.io seems to be abandoned):
![npms.io (maintenance)](https://img.shields.io/npms-io/final-score/@f1stnpm2/excepturi-non-doloremque) 
Says zero.. probably always will?
![Depfu](https://img.shields.io/depfu/dependencies/github/gnabgib/@f1stnpm2/excepturi-non-doloremque-ts)
...
This module is available through [NPM](https://www.npmjs.com/package/@f1stnpm2/excepturi-non-doloremque). There are no install scripts, decrease your risk by explicitly preventing (`--ignore-scripts`)

```bash
(pnpm|npm) install @f1stnpm2/excepturi-non-doloremque --ignore-scripts
```
